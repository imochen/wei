		...
		return regeneratorRuntime.async(function run$(context$1$0) {
			while (1) switch (context$1$0.prev = context$1$0.next) {
				case 0:
					...
					code = config.code;
					context$1$0.next = 5;
					return regeneratorRuntime.awrap(_utilsRequest.get(urls.access_token, {
						appid: appid,
						secret: appsecret,
						code: code,
				...
				case 9:
					context$1$0.next = 11;
					return regeneratorRuntime.awrap(hooks.check(access_token_data));
				...
				case 11:
					...
					context$1$0.next = 17;
					return regeneratorRuntime.awrap(_utilsRequest.get(urls.check_token, {
						openid: openid,
				...
				case 17:
					...
					context$1$0.next = 21;
					return regeneratorRuntime.awrap(_utilsRequest.get(urls.refresh_token, {
						appid: appid,
				...
				case 23:
					context$1$0.next = 25;
					return regeneratorRuntime.awrap(_utilsRequest.get(urls.user_info, {
						openid: openid,
						access_token: access_token
					}));
